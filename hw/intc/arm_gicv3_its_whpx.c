...
#define TYPE_WHPX_ARM_ITS "arm-its-whpx"
typedef struct GICv3ITSClass GICv3ITSClass;
/* This is reusing the GICv3ITSState typedef from ARM_GICV3_ITS_COMMON */
DECLARE_OBJ_CHECKERS(GICv3ITSState, GICv3ITSClass,
                     ARM_GICV3_ITS, TYPE_WHPX_ARM_ITS)
...
static const Property gicv3_its_props[] = {
    DEFINE_PROP_LINK("parent-gicv3", GICv3ITSState, gicv3, "arm-gicv3-whpx",
                     GICv3State *),
};
...
static void whpx_its_register_types(void)
{
    type_register_static(&gicv3_its_info);
}

type_init(whpx_its_register_types)
